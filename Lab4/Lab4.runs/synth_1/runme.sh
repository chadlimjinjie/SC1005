...
HD_PWD='C:/Users/chadl/Documents/SC1005 Lab/Lab4/Lab4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vaddoflow.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vaddoflow.tcl
